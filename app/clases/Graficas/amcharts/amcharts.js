...
AmCharts.ValueAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function(a) {
                ...
                if (m = h[n], m.hidden)
                    ...
                    if (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g))
                        ...
                        "regular" == b && (q && (isNaN(c[k]) ? (c[k] = g, l.values.close = g, l.values.open = this.baseValue) : (isNaN(g) ? l.values.close = c[k] : l.values.close = g + c[k], l.values.open = c[k], c[k] = l.values.close)), "column" == a && (m.newStack && (e[k] = NaN, d[k] = NaN), l.values.close = g, 0 > g ? (l.values.close = g, isNaN(d[k]) ? l.values.open = p : (l.values.close += d[k], l.values.open = d[k]), d[k] = l.values.close) :
                                (l.values.close = g, isNaN(e[k]) ? l.values.open = p : (l.values.close += e[k], l.values.open = e[k]), e[k] = l.values.close)))
                    }
        }
        for (k = this.start; k <= this.end; k++)
            for (n = 0; n < h.length; n++)
                (m = h[n], m.hidden) ? m.newStack && (e[k] = NaN, d[k] = NaN) : (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, isNaN(g) || (c = g / f[k] * 100, l.values.percents = c, l.values.total = f[k], m.newStack && (e[k] = NaN, d[k] = NaN), "100%" == b && (isNaN(d[k]) && (d[k] = 0), isNaN(e[k]) && (e[k] = 0), 0 >
                        c ? (l.values.close = AmCharts.fitToBounds(c + d[k], -100, 100), l.values.open = d[k], d[k] = l.values.close) : (l.values.close = AmCharts.fitToBounds(c + e[k], -100, 100), l.values.open = e[k], e[k] = l.values.close)))))
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (d.valueAxis == this) {
                ...
                for (l = g; l <= h && (g = this.data[l].axes[this.id].graphs[d.id],
        ...
        "serial" == b.type && (!0 !== b.categoryAxis.parseDates || a || this.end <
                this.data.length - 1 && this.end++);
        ...
        isNaN(this.maximum) && isNaN(this.maxTemp) && (this.max =
                Math.ceil(this.max / d) * d + d);
        ...
        d && (this.min = a * d, this.max = c * d, this.step = b * d, a = Math.pow(10, Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)), a = Math.abs(Math.log(Math.abs(a)) * Math.LOG10E), this.maxDecCount = a = Math.round(a),
                this.draw())
    }});
...
AmCharts.AmChart = AmCharts.Class({construct: function(a) {
        ...
        a && (isNaN(a.precision) || (this.precision = a.precision), void 0 !==
                a.thousandsSeparator && (this.thousandsSeparator = a.thousandsSeparator), void 0 !== a.decimalSeparator && (this.decimalSeparator = a.decimalSeparator));
    ...
    }, addLabel: function(a, b, c, d, e, f, g,
            h, k, l) {
        ...
        var a;
        this.dispatchDataUpdated && (this.dispatchDataUpdated = !1, a = "dataUpdated",
    ...
    brr: function() {
        ...
        if ("amcharts.com" != b || !0 === this.inIframe()) {
            ...
            f.opacity = .7;
            f.display = "block";
            var g = k.offsetWidth, k = k.offsetHeight, h = 5 +
                    b, l = c + 5;
...
AmCharts.AmGraph = AmCharts.Class({construct: function(a) {
    ...
    createRadarGraph: function() {
        ...
        var ja, x, ab, jb = n + 1, kb = m + 1, bb = 0, lb = 0, mb, nb, cb, db, ob = this.fillColorsR,
                Da = this.negativeFillColors, wa = this.negativeLineColor, Sa = this.fillAlphas, Ta = this.negativeFillAlphas;
        ...
        for (J = ha; J <= ba; J++) {
            ...
            if (l && void 0 == this.openField)
                for (var pb = J + 1; pb < d.length && (!d[pb] || !(Va = d[J + 1].axes[f.id].graphs[b]) || !Va.values || (Na = Va.values.value, isNaN(Na))); pb++)
                    ;
            ...
            if (va) {
                ...
                -1E5 > la && (la = -1E5);
                la > m + 1E5 && (la = m + 1E5);
                q ? (D = C, N = M, M = C = la, isNaN(ka) && !this.fillToGraph &&
                        (N = na), Fa = xa, Ga = ya) : (N = D = la, isNaN(ka) && !this.fillToGraph && (M = na));
                ...
                switch (g) {
                    case "line":
                        if (isNaN(U))
                            ...
                            if (Ua || void 0 != x.lineColor || void 0 != x.fillColors ||
                                    !isNaN(x.dashLength))
                                this.drawLineGraph(w, t, O, P), w = [D], t = [C], O = [], P = [], !Ea || isNaN(M) || isNaN(N) || (O.push(N), P.push(M)), l ? Ma ? (this.lineColorSwitched = oa, this.fillColorsSwitched = ob) : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da) : (this.lineColorSwitched = x.lineColor, this.fillColorsSwitched = x.fillColors), this.dashLengthSwitched = x.dashLength;
                    ...
                    case "step":
                        if (!isNaN(U)) {
                            if (void 0 ==
                                    ...
                                    isNaN(M) || isNaN(N) || (O.push(N - ma), P.push(A), O.push(N - ma), P.push(M), O.push(N + za), P.push(M))), u = D, y = C, E = N, A = M, aa = D, ia = C, ea = D, fa = C, Ua && (this.drawLineGraph(w, t, O, P), w = [], t = [], O = [], P = [], l && (Ma ? (this.lineColorSwitched = oa, this.fillColorsSwitched = ob) : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da))), Gb || x.gap)
                        ...
                        if (!isNaN(U)) {
                            ...
                            if (!(U < Ib && ka < Ib || U > Jb && ka > Jb))
                                if (q) {
                                    ...
                                    T < n && 0 < Q && (ra = new AmCharts.Cuboid(e, da, Q, I - a.d3x, F - a.d3y,
                                            Ca, Wa, X, pa, Z, G, s, q, R, Xa), "bottom" != L && "inside" != L && "middle" != L && (L = f.reversed ? "left" : "right", 0 > U && (L = f.reversed ? "right" : "left")), "regular" == H || "100%" == H) && (aa += this.dx)
                                } else {
                                    ...
                                    if (S < m + V * I && 0 < Q)
                                        if (ra = new AmCharts.Cuboid(e, Q, da, I - a.d3x, F - a.d3y, Ca,
                                                Wa, X, pa, this.lineAlpha, G, s, q, R, Xa), 0 > U && "middle" != L && "inside" != L)
                                            L = "bottom";
                            ...
                            if (ra && (sa = ra.set, x.columnGraphics = sa, sa.translate(S, T), this.columnsSet.push(sa), (x.url || this.showHandOnHover) && sa.setAttr("cursor", "pointer"), !$)) {
                                ...
                                "3d" == H && (q ? (K = (this.end + 1 - J) * z - c - 1E3 * this.depthCount, aa += I * this.columnIndex, ea += I * this.columnIndex, x.y += I * this.columnIndex) : (K = (z - c) * (J + 1) + 1E3 * this.depthCount, aa += 3, ia += F * this.columnIndex +
                                        7, fa += F * this.columnIndex, x.y += F * this.columnIndex));
                                if ("regular" == H || "100%" == H)
                                    "inside" != L && (L = "middle"), K = q ? 0 < va.value ? (this.end + 1 - J) * z + c : (this.end + 1 - J) * z - c : 0 < va.value ? z * J + c : z * J - c;
                    ...
                    case "candlestick":
                        if (!isNaN(ka) && !isNaN(U)) {
                            ...
                            if (q) {
                                ...
                                !isNaN(ya) && !isNaN(xa) && D < m && 0 < D && (ib = AmCharts.line(e, [D, D], wb, pa, Z, X), tb = AmCharts.line(e,
                                        [D, D], xb, pa, Z, X))
                            }
                    ...
                    if (this.end - this.start <= Mb || 0 === Mb) {
                        ...
                        if (Nb) {
                            ...
                            switch (L) {
                                ...
                                case "inside":
                                    q ? (Ja =
                                            -(Ka / 2) + this.fontSize / 2, Ia = 0 > da ? Pa / 2 + 6 : -Pa / 2 - 6) : Ja = 0 > da ? Ka : -Ka
                            }
                            if (ga) {
        ...
        if (1 < a.length) {
            ...
            if (0 <
                    f || 0 < t)
                if (n = a.join(";").split(";"), q = b.join(";").split(";"), m = g.type, "serial" == m ? 0 < c.length ? (c.reverse(), d.reverse(), n = a.concat(c), q = b.concat(d)) : e.rotate ? (q.push(q[q.length - 1]), n.push(u), q.push(q[0]), n.push(u), q.push(q[0]), n.push(n[0])) : (n.push(n[n.length - 1]), q.push(u), n.push(n[0]), q.push(u), n.push(a[0]), q.push(q[0])) : "xy" == m && (b = e.fillToAxis) && (AmCharts.isString(b) && (b = g.getValueAxisById(b)), "H" == b.orientation ? (u = "top" == b.position ? 0 : b.viH, n.push(n[n.length - 1]), q.push(u), n.push(n[0]), q.push(u), n.push(a[0]),
                        q.push(q[0])) : (u = "left" == b.position ? 0 : b.viW, q.push(q[q.length - 1]), n.push(u), q.push(q[0]), n.push(u), q.push(q[0]), n.push(n[0]))), a = e.gradientRotation, 0 < f && (g = AmCharts.polygon(h, n, q, r, f, 1, "#000", 0, a), g.pattern(e.pattern), k.push(g)), w || void 0 !== s)
