<?php
    ...
    abstract class BarChart extends Chart {
        ...
        protected $stackGraph=false;
        
        protected $percentSimbolCaption=false;
        
        
        public function setStackGraph($state){
            $this->stackGraph = $state;
        }
        
        public function setPercentSymbolCaption($state){
            $this->percentSimbolCaption=$state;
        }
         ...
         */
        protected function BarChart($width, $height, $padd=0) {
            parent::Chart($width, $height, $padd);
