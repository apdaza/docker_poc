<?php
    ...
    class VerticalBarChart extends BarChart {
        ...
        protected function printStackBar(){
            ...
            for ($j = 0; $j < $serieCount; $j++) {
                ...
                for ($i = 0; $i < $pointCount; $i++) {
                    ...
                    $valueText = number_format(($point->getY()/$totales[$i])*100,2,',','.');
                    
                    $value = ($lista[$i]/$totales[$i])*100;
                    ...
                    $barWidth = $columnWidthWithMargin;
                    ...
                    if ($this->config->getShowPointCaption()) {
                        ...
                        $text->printText($img, $x1 + $barWidth / 2 , $ymin - 5, $this->plot->getTextColor(), $temp, $text->fontCondensed, $text->HORIZONTAL_CENTER_ALIGN | $text->VERTICAL_BOTTOM_ALIGN);
                    }
        ...
        public function render($fileName = null) {
            ...
            $this->checkDataModel();
            if ($this->stackGraph && !$this->percentSimbolCaption) {
                $this->bound->setUpperBound($this->getMax());
            }
            if ($this->stackGraph && $this->percentSimbolCaption) {
                $this->bound->setUpperBound(120);
            }
