...
switch ($task) {
    ...
    case 'add':
        ...
        $form->addEtiqueta(CORRESPONDECIA_CODIGO_REFERENCIA);
        $form->addInputText('text', 'txt_codigo_referencia', 'txt_codigo_referencia', 30, 0, $codigoReferencia, '', 'onfocus="this.blur(); return false;"');
        ...
        $form->addInputFile('file', 'file_correspondencia_respuesta_add', 'file_correspondencia_respuesta_add', '25', 'file', 'onChange="ocultarDiv(\'error_documento_respuesta\');actualizaCampos();"');
        $form->addError('error_documento_respuesta', ERROR_CORRESPONDECIA_RESPUESTA);

        /*
         * Campo consecutivo.
         */    
        $form->addEtiqueta(CORRESPONDECIA_CONSECUTIVO_RESPUESTA);
        $form->addInputText('text', 'num_consecutivo_respuesta_add', 'num_consecutivo_respuesta_add', 15, 5, $consecutivoRespuesta, '', 'onChange=ocultarDiv(\'error_consecutivo_respuesta\');');
        ...
        /*
         * campo estado de los comunicados.
         */ 
        /**/
//        $estados = $corrData->getEstado('1','doe_id');
//        $opciones=null;
//        if(isset($estados)){
...
//        $form->addSelect('select','sel_estado_add','sel_estado_add',$opciones,DOCUMENTO_ESTADO,$estado,'','');
//        
    ...
    case 'saveAdd':
        ...
        $m = $doc_correspondencia->saveNewCorrespondencia($documentoSoporte, $documentoAnexo, $documentoRespuesta);
...
//        
    ...
    case 'listAlarmas':
        ...
        if ($criterio == "") {
            $criterio = " doe.doe_id <> 1 and doe.doe_id <> 2 ";
        }else{
            $criterio .= " and doe.doe_id <> 1 and doe.doe_id <> 2 ";
        }
